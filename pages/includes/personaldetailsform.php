<div class="w3-card w3-white w3-animate-left w3-padding-large w3-hide healthforms" style="width:90%;height:90%;overflow: auto;">
   	...
   	<ul class="w3-ul">
   		...
   		<li class="healthformslist w3-border-0">
   		 <div class="listitemcontainer">
   		     ...
   		     <div class="listitemcontainer">
   		     	<input type="text" class="w3-input w3-border-0 w3-border-bottom w3-border-blue w3-hover-border-green"name="firstname" id="firstname" placeholder="First Name eg John Doe">
   		     </div>
   		</li>
         ...
         <li class="healthformslist w3-border-0">
          <div class="listitemcontainer">
            <b>2.2 Surname</b>
              ...
              <div class="listitemcontainer">
               <input type="text" class="w3-input w3-border-0 w3-border-bottom w3-border-blue w3-hover-border-green"name="surname" id="surname" placeholder="Surname eg John">
              </div>
         </li>
          ...
          <div class="listitemcontainer">
            <b>2.3 Type of ID</b>
              ...
              <div class="listitemcontainer">
               <input type="text" class="w3-input w3-border-0 w3-border-bottom w3-border-blue w3-hover-border-green"name="typeofid" id="typeofid" placeholder="ID Type">
               <label for="idnumber"><b>ID Number/Date of Birth</b></label>

               <input type="text" class="w3-input w3-border-0 w3-border-bottom w3-border-blue w3-hover-border-green"name="idnumber" id="idnumber" placeholder="ID Number">

               <input type="date" class="w3-input w3-border-0 w3-border-bottom w3-border-blue w3-hover-border-green"name="dateofbirth" id="dateofbirth" placeholder="Date of Birth">

               <label for="age">Age :</label>
               <input type="number" class="w3-input w3-border-0 w3-border-bottom w3-border-blue w3-hover-border-green"name="age" id="age" placeholder="Age">
              </div>
         </li>
         ...
         <li class="healthformslist w3-border-0">
          <div class="listitemcontainer">
            <b>2.4 CellPhone</b>
              ...
              <div class="listitemcontainer">
               <input type="tel" class="w3-input w3-border-0 w3-border-bottom w3-border-blue w3-hover-border-green"name="cellphone" id="cellphone" placeholder="CellPhone">
              </div>
         </li>
